...
/*
SEGUNDA TENTATIVA:
    Aloquei o pAgenda como se fosse para guardar todas as pessoas nele, dando realloc repetidamente e causando falhas no código.
    Além disso, faltou aplicar as regras de heap na implementação.
...
void AdicionarPrimeiraPessoa ( ) {
    ...
    * ( char ** )( pBuffer + 17 ) = ( char * ) pAgenda; // seta o inicio da lista
    * ( char ** )( pBuffer + 21 ) = ( char * ) pAgenda; // seta o fim da lista

    printf("Inicio da agenda com uma pessoa: %s\n",* ( char ** )( pBuffer + 17 ));
}
...
void AdicionarPessoa ( ) {
    ...
    printf("Inicio da agenda com duas pessoa: %s\n",* ( char ** )( pBuffer + 17 ));
    ...
    * ( char * )( pAgenda + ( 52 * ( * ( int * )( pBuffer + 13 ))) + 24 + * ( int * )( pBuffer + 9 )) = '\0';
    ...
    void *atual = * ( char ** )( pBuffer + 17 ); // ponteiro auxiliar para encontrar a posicao correta para o nodo atual
...
void RemoverPessoa(){
    ...
    if ( busca == NULL ) {
        ...
        if ( ( char * ) busca == ( char * )( pBuffer + 17 ) ) { // se a pessoa for a primeira da lista
            if( * ( int * )( pBuffer + 5 ) == 1 ){
                * ( char ** )( pBuffer + 17 ) = NULL;
                * ( char ** )( pBuffer + 17 ) = NULL;
                * ( int * )( pBuffer + 5 ) = 0;
                free ( busca );
            } else {
                * ( char ** ) ( * ( char ** )( busca + 48 ) + 44 ) = NULL; // busca->prox->ant = NULL;
                * ( char ** )( pBuffer + 17 ) = * ( char ** )( busca + 48 ); // inicio da lista vira busca->prox
                * ( int * )( pBuffer + 5 ) -= 1; // diminui o tamanho da lista
                free ( busca );
            }
        } else if ( ( char * ) busca == ( char * )( pBuffer + 21 ) ) { // se a pessoa for a ultima da lista
            // se só tivesse 1 pessoa na lista, teria entrado no primeiro if, então só pode ter mais de uma
            * ( char ** ) ( * ( char ** )( busca + 44 ) + 48 ) = NULL; // busca->ant->prox = NULL;
            * ( char ** )( pBuffer + 21 ) = * ( char ** )( busca + 44 ); // fim da lista vira busca->ant
            * ( int * )( pBuffer + 5 ) -= 1; // diminui o tamanho da lista
            free ( busca );
        } else {
             * ( char ** ) ( * ( char ** )( busca + 44 ) + 48 ) = * ( char ** )( busca  + 48 ); //busca->ant->prox = busca->prox;
             * ( char ** ) ( * ( char ** )( busca + 48 ) + 44 ) = * ( char ** )( busca  + 44 );//busca->prox->ant = busca->ant;
             * ( int * )( pBuffer + 5 ) -= 1; // diminui o tamanho da lista
            free ( busca );
        }
