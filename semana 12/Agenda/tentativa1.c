...
/*
PRIMEIRA TENTATIVA:
    Na minha primeira vez tentando fazer a agenda, achei que deveria guardar exatamente o numero de char ocupado por cada nome e email para ocupar memória.
    Isso resultou em muitos erros e não consegui avançar com essa ideia.
*/
